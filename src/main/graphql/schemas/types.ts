...
export type Mutation = {
  __typename?: 'Mutation';
  userRegistration: Scalars['String']['output'];
};
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  userRegistration?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationUserRegistrationArgs, 'input'>>;
};
